...
<!--        <el-table-column prop="dName" label="密码" width="80">-->
<!--        </el-table-column>-->
    ...
    requestTime(id) {
      ...
      request
          ...
          .then((res) => {
            ...
            // if (!this.isTimeAfterTarget("18:30") || !isToday) {
            //   array.push(
            //       "17:30-18:30  " + "   余号 " + res.data.data.sTOs
            //   );
            // }
            // if (!this.isTimeAfterTarget("19:30") || !isToday) {
            //   array.push(
            //       "18:30-19:30  " + "   余号 " + res.data.data.sTOs
            //   );
            // }
            this.times = array;
          });
